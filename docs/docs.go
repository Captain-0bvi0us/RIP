    ...
    "paths": {
        ...
        "/factors": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные нового фактора",
                        "name": "factorData",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.FactorCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/factors/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.FactorUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID фактора для удаления",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/frax/draft/factors/{factor_id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID фактора для добавления",
                        "name": "factor_id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.FraxUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.FactorToFraxUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.FraxResolveRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "ds.FraxDTO": {
            ...
            "properties": {
                ...
                "factors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ds.FactorInFraxDTO"
                    }
                },
                "forming_date": {
                    "type": "string"
